...
export const metadata: Metadata = {
  title: "VideoRep — B2B Video Presenter Trusted by 250+ Brands",
    ...
    <>
      ...
      <main id="main-content">
        ...
        <section className="section section--white" aria-labelledby="faq-heading">
          <div className="container"><div className="section__header"><span className="eyebrow">FAQ</span><h2 id="faq-heading">Questions Answered</h2></div><FAQ items={homeFAQ} /></div>
        </section>
